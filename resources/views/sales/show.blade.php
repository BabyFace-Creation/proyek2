                                    ...
                                    <td class="td-actions text-right">
                                        @if(!$sale->finalized_at)
                                            ...
                                            <form action="{{ route('sales.product.destroy', ['sale' => $sale, 'soldproduct' => $sold_product]) }}" method="post" class="d-inline">
                                                @csrf
                                                @method('delete')
                                                <button type="button" class="btn btn-link" data-toggle="tooltip" data-placement="bottom" title="Delete" onclick="confirm('Are You Sure You Want To Delete This, Anything That You Add All Will Be Deleted, And There Is No Return') ? this.parentElement.submit() : ''">
